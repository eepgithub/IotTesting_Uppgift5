...
namespace DeviceApp
{
    class Program
    {
        private static DeviceClient deviceClient = DeviceClient.CreateFromConnectionString("HostName=EC-iothub.azure-devices.net;DeviceId=DeviceApp;SharedAccessKey=Uho9XBqKP6e7EcM/sp60iZ+lfotgGSzkRp87I75IsQM=", TransportType.Mqtt);
